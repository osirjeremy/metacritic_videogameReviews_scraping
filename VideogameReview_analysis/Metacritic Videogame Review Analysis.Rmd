...
Context on videogame industry - cite rapid growth; increasing dominance of pop culture
Quick personal note for conducting research
Project research questions for consumers (gamers) and developers
...
library(magrittr)
library(knitr)
# #top10.user.games.tbl <- knitr::kable(top10.user.games,
#   caption = "Hall of Fame: Top 10 Games according to Users\n\n",
#   align ="lccc")
